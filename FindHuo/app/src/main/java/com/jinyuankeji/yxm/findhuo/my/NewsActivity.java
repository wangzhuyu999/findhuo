...
import com.jinyuankeji.yxm.findhuo.my.adapter.NewsAdapter;
...
import static com.jinyuankeji.yxm.findhuo.tools.URLValue.noticeList;
...
public class NewsActivity extends Activity{
    ...
    private void request() {
        ...
        // 发送请求数据
        httpUtils.send(HttpRequest.HttpMethod.POST, URLValue.URL_NOR + noticeList, params,
