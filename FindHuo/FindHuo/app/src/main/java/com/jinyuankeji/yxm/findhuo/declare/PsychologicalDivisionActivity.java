...
public class PsychologicalDivisionActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //截图后显示
                showPicturePicker(PsychologicalDivisionActivity.this,true);
            }
        });

        iv_image2 = (ImageView) this.findViewById(R.id.img2);
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case TAKE_PICTURE:
                    ...
                    iv_image2.setImageBitmap(newBitmap);
                ...
                case CHOOSE_PICTURE:
                    ...
                    try {
                        ...
                        if (photo != null) {
                            ...
                            iv_image2.setImageBitmap(smallBitmap);
                        }
                ...
                case CROP_PICTURE:
                    ...
                    iv_image2.setImageBitmap(photo);
                    break;
                default:
                    break;
            }
